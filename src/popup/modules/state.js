...
export function initElements() {
  state.elements = {
    ...
    configureTokenBtn: document.getElementById('configureTokenBtn'),
    uploadToCloudBtn: document.getElementById('uploadToCloudBtn'),
    downloadFromCloudBtn: document.getElementById('downloadFromCloudBtn'),
    tokenConfigModal: document.getElementById('tokenConfigModal'),
    closeTokenConfig: document.getElementById('closeTokenConfig'),
